...
local combat1 = createCombat(initCombat, AREA_BEAM6_LOCAL)
local combat2 = createCombat(initCombat, AREA_BEAM7_LOCAL)
local combat3 = createCombat(initCombat, AREA_BEAM8_LOCAL)
